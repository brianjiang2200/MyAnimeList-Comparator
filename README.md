Hi! Thanks for checking out this small webapp. It uses the Jikan.moe API to find common anime and manga among multiple users as well as their scores from the MyAnimelist site.  
